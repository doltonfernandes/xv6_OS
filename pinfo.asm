...
main(int argc,char *argv[])
{
  ...
  1c:	e8 4f 02 00 00       	call   270 <atoi>
  21:	5a                   	pop    %edx
  22:	59                   	pop    %ecx
  23:	50                   	push   %eax
  24:	56                   	push   %esi
  25:	e8 60 03 00 00       	call   38a <getpinfo>
  2a:	83 c4 10             	add    $0x10,%esp
  2d:	85 c0                	test   %eax,%eax
  2f:	78 51                	js     82 <main+0x82>
	{
		printf(1,"Not Found\n");
		exit();
	}
  ...
  34:	ff 75 d0             	pushl  -0x30(%ebp)
  37:	ff 75 cc             	pushl  -0x34(%ebp)
  3a:	ff 75 c8             	pushl  -0x38(%ebp)
  3d:	ff 75 c4             	pushl  -0x3c(%ebp)
	for(int j=0;j<5;j++)
  ...
  4e:	83 c4 20             	add    $0x20,%esp
	...
	{
		printf(1,"ticks [%d] = %d\n",j+1,p.ticks[j]);
  51:	8b 44 9e 10          	mov    0x10(%esi,%ebx,4),%eax
  55:	83 c3 01             	add    $0x1,%ebx
  58:	50                   	push   %eax
  59:	53                   	push   %ebx
  5a:	68 6b 07 00 00       	push   $0x76b
  5f:	6a 01                	push   $0x1
  ...
  69:	83 fb 05             	cmp    $0x5,%ebx
  6c:	75 e3                	jne    51 <main+0x51>
	{
		printf(1,"ticks [%d] = %d\n",j+1,p.ticks[j]);
	}
	printf(1,"--------------\n");
  6e:	83 ec 08             	sub    $0x8,%esp
  71:	68 7c 07 00 00       	push   $0x77c
  76:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3df:	f7 f6                	div    %esi
 3e1:	0f b6 92 d8 07 00 00 	movzbl 0x7d8(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 558:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 55b:	b8 d0 07 00 00       	mov    $0x7d0,%eax
...
free(void *ap)
{
 ...
 637:	89 08                	mov    %ecx,(%eax)
  freep = p;
 639:	a3 78 0a 00 00       	mov    %eax,0xa78
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 65d:	a3 78 0a 00 00       	mov    %eax,0xa78
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 78 0a 00 00    	mov    0xa78,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6cf:	76 3f                	jbe    710 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	39 05 78 0a 00 00    	cmp    %eax,0xa78
 ...
 6f6:	e8 e5 fe ff ff       	call   5e0 <free>
  return freep;
 6fb:	8b 15 78 0a 00 00    	mov    0xa78,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 734:	eb e9                	jmp    71f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 736:	c7 05 78 0a 00 00 7c 	movl   $0xa7c,0xa78
 73d:	0a 00 00 
 740:	c7 05 7c 0a 00 00 7c 	movl   $0xa7c,0xa7c
 747:	0a 00 00 
    base.s.size = 0;
 74a:	b8 7c 0a 00 00       	mov    $0xa7c,%eax
 74f:	c7 05 80 0a 00 00 00 	movl   $0x0,0xa80
 756:	00 00 00 
