...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 3b 7a 10 80 	movl   $0x80107a3b,(%esp)
...
80101e98:	68 22 78 10 80       	push   $0x80107822
...
80102e12:	e8 a9 2a 00 00       	call   801058c0 <idtinit>
...
80102e33:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e36:	e8 a5 3b 00 00       	call   801069e0 <switchkvm>
  seginit();
80102e3b:	e8 a0 3a 00 00       	call   801068e0 <seginit>
  lapicinit();
...
80102e99:	e8 12 2d 00 00       	call   80105bb0 <uartinit>
  pinit();         // process table
80102e9e:	e8 2d 08 00 00       	call   801036d0 <pinit>
  tvinit();        // trap vectors
80102ea3:	e8 78 29 00 00       	call   80105820 <tvinit>
  binit();         // buffer cache
...
80103608:	89 43 7c             	mov    %eax,0x7c(%ebx)
  ...
  release(&ptable.lock);
8010360b:	e8 a0 0f 00 00       	call   801045b0 <release>
...
8010362d:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103630:	c7 40 14 12 58 10 80 	movl   $0x80105812,0x14(%eax)
...
8010363c:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010363f:	e8 bc 0f 00 00       	call   80104600 <memset>
...
80103668:	e8 43 0f 00 00       	call   801045b0 <release>
  return 0;
...
8010375a:	68 f8 76 10 80       	push   $0x801076f8
...
80103a7e:	e8 7d 0a 00 00       	call   80104500 <acquire>
...
80103abf:	c7 43 84 04 00 00 00 	movl   $0x4,-0x7c(%ebx)
      ...
      swtch(&(c->scheduler), p->context);
80103ac6:	e8 90 0d 00 00       	call   8010485b <swtch>
      switchkvm();
...
80103af0:	e8 bb 0a 00 00       	call   801045b0 <release>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103b05:	e8 16 09 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103b0a:	e8 e1 fb ff ff       	call   801036f0 <mycpu>
  p = c->proc;
80103b0f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b15:	e8 46 09 00 00       	call   80104460 <popcli>
sched(void)
{
  int intena;
...
80103b22:	e8 a9 09 00 00       	call   801044d0 <holding>
...
80103b63:	e8 f3 0c 00 00       	call   8010485b <swtch>
  mycpu()->intena = intena;
...
80103b80:	68 50 76 10 80       	push   $0x80107650
...
80103b8d:	68 7c 76 10 80       	push   $0x8010767c
...
80103b9a:	68 6e 76 10 80       	push   $0x8010766e
...
80103ba7:	68 62 76 10 80       	push   $0x80107662
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103bc9:	e8 52 08 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103bce:	e8 1d fb ff ff       	call   801036f0 <mycpu>
  p = c->proc;
80103bd3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103bd9:	e8 82 08 00 00       	call   80104460 <popcli>
{
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
...
80103bea:	0f 84 01 01 00 00    	je     80103cf1 <exit+0x131>
    panic("init exiting");
...
80103c24:	a1 a0 57 11 80       	mov    0x801157a0,%eax
  }
  ...
  end_op();
  curproc->cwd = 0;
80103c29:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)

  curproc->etime = ticks; // End Time
80103c30:	89 86 80 00 00 00    	mov    %eax,0x80(%esi)

  acquire(&ptable.lock);
80103c36:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103c3d:	e8 be 08 00 00       	call   80104500 <acquire>

  // Parent might be sleeping in wait().
  wakeup1(curproc->parent);
80103c42:	8b 56 14             	mov    0x14(%esi),%edx
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c48:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103c4d:	eb 0d                	jmp    80103c5c <exit+0x9c>
80103c4f:	90                   	nop
80103c50:	05 88 00 00 00       	add    $0x88,%eax
80103c55:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103c5a:	74 1e                	je     80103c7a <exit+0xba>
    if(p->state == SLEEPING && p->chan == chan)
80103c5c:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103c60:	75 ee                	jne    80103c50 <exit+0x90>
80103c62:	3b 50 20             	cmp    0x20(%eax),%edx
80103c65:	75 e9                	jne    80103c50 <exit+0x90>
      p->state = RUNNABLE;
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c6e:	05 88 00 00 00       	add    $0x88,%eax
80103c73:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103c78:	75 e2                	jne    80103c5c <exit+0x9c>
  wakeup1(curproc->parent);
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->parent == curproc){
      p->parent = initproc;
80103c7a:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
80103c80:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103c85:	eb 17                	jmp    80103c9e <exit+0xde>
...
80103c9c:	74 3a                	je     80103cd8 <exit+0x118>
    if(p->parent == curproc){
80103c9e:	39 72 14             	cmp    %esi,0x14(%edx)
80103ca1:	75 ed                	jne    80103c90 <exit+0xd0>
      p->parent = initproc;
      if(p->state == ZOMBIE)
...
80103ca7:	89 4a 14             	mov    %ecx,0x14(%edx)
      if(p->state == ZOMBIE)
80103caa:	75 e4                	jne    80103c90 <exit+0xd0>
80103cac:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103cb1:	eb 11                	jmp    80103cc4 <exit+0x104>
80103cb3:	90                   	nop
...
80103cc2:	74 cc                	je     80103c90 <exit+0xd0>
    if(p->state == SLEEPING && p->chan == chan)
80103cc4:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103cc8:	75 ee                	jne    80103cb8 <exit+0xf8>
80103cca:	3b 48 20             	cmp    0x20(%eax),%ecx
80103ccd:	75 e9                	jne    80103cb8 <exit+0xf8>
      p->state = RUNNABLE;
80103ccf:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80103cd6:	eb e0                	jmp    80103cb8 <exit+0xf8>
        wakeup1(initproc);
    }
  }
...
80103cd8:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  sched();
80103cdf:	e8 1c fe ff ff       	call   80103b00 <sched>
  panic("zombie exit");
80103ce4:	83 ec 0c             	sub    $0xc,%esp
80103ce7:	68 9d 76 10 80       	push   $0x8010769d
...
80103cf4:	68 90 76 10 80       	push   $0x80107690
...
80103d0c:	e8 ef 07 00 00       	call   80104500 <acquire>
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
80103d11:	e8 0a 07 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103d16:	e8 d5 f9 ff ff       	call   801036f0 <mycpu>
  p = c->proc;
80103d1b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d21:	e8 3a 07 00 00       	call   80104460 <popcli>
// Give up the CPU for one scheduling round.
void
yield(void)
{
...
80103d39:	e8 72 08 00 00       	call   801045b0 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103d5f:	e8 bc 06 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103d64:	e8 87 f9 ff ff       	call   801036f0 <mycpu>
  p = c->proc;
80103d69:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d6f:	e8 ec 06 00 00       	call   80104460 <popcli>
void
sleep(void *chan, struct spinlock *lk)
{
  struct proc *p = myproc();
...
80103d90:	e8 6b 07 00 00       	call   80104500 <acquire>
    release(lk);
80103d95:	89 34 24             	mov    %esi,(%esp)
80103d98:	e8 13 08 00 00       	call   801045b0 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80103dba:	e8 f1 07 00 00       	call   801045b0 <release>
    acquire(lk);
...
80103dcb:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103dcc:	e9 2f 07 00 00       	jmp    80104500 <acquire>
...
80103df9:	68 af 76 10 80       	push   $0x801076af
...
80103e06:	68 a9 76 10 80       	push   $0x801076a9
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103e15:	e8 06 06 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103e1a:	e8 d1 f8 ff ff       	call   801036f0 <mycpu>
  p = c->proc;
80103e1f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103e25:	e8 36 06 00 00       	call   80104460 <popcli>
{
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
80103e32:	e8 c9 06 00 00       	call   80104500 <acquire>
...
80103edb:	e8 d0 06 00 00       	call   801045b0 <release>
        return pid;
...
80103ef4:	e8 b7 06 00 00       	call   801045b0 <release>
      return -1;
...
80103f1f:	e8 dc 05 00 00       	call   80104500 <acquire>
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103f5a:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103f65:	e9 46 06 00 00       	jmp    801045b0 <release>
...
80103f7f:	e8 7c 05 00 00       	call   80104500 <acquire>
...
80103fb6:	e8 f5 05 00 00       	call   801045b0 <release>
      return 0;
...
80103fe0:	e8 cb 05 00 00       	call   801045b0 <release>
  return -1;
...
8010401b:	68 3b 7a 10 80       	push   $0x80107a3b
...
80104041:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80104044:	ba c0 76 10 80       	mov    $0x801076c0,%edx
  uint pc[10];
...
8010404b:	8b 14 85 20 77 10 80 	mov    -0x7fef88e0(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
80104052:	b8 c0 76 10 80       	mov    $0x801076c0,%eax
...
80104061:	68 c4 76 10 80       	push   $0x801076c4
...
80104088:	e8 33 03 00 00       	call   801043c0 <getcallerpcs>
...
8010409d:	68 01 71 10 80       	push   $0x80107101
...
801040c5:	8d 45 f0             	lea    -0x10(%ebp),%eax
  }
}
...
801040ce:	6a 00                	push   $0x0
801040d0:	e8 8b 08 00 00       	call   80104960 <argptr>
  argptr(1,(void*)&rtime,sizeof(*rtime));
801040d5:	8d 45 f4             	lea    -0xc(%ebp),%eax
801040d8:	83 c4 0c             	add    $0xc,%esp
801040db:	6a 04                	push   $0x4
801040dd:	50                   	push   %eax
801040de:	6a 01                	push   $0x1
801040e0:	e8 7b 08 00 00       	call   80104960 <argptr>
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
801040e5:	e8 36 03 00 00       	call   80104420 <pushcli>
  c = mycpu();
801040ea:	e8 01 f6 ff ff       	call   801036f0 <mycpu>
  p = c->proc;
801040ef:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801040f5:	e8 66 03 00 00       	call   80104460 <popcli>
  ...
  acquire(&ptable.lock);
801040fa:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104101:	e8 fa 03 00 00       	call   80104500 <acquire>
80104106:	83 c4 10             	add    $0x10,%esp
  for(;;){
    // Scan through table looking for exited children.
    havekids = 0;
80104109:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010410b:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80104110:	eb 14                	jmp    80104126 <sys_waitx+0x66>
...
80104124:	74 22                	je     80104148 <sys_waitx+0x88>
      if(p->parent != curproc)
80104126:	39 73 14             	cmp    %esi,0x14(%ebx)
80104129:	75 ed                	jne    80104118 <sys_waitx+0x58>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
8010412b:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
8010412f:	74 3d                	je     8010416e <sys_waitx+0xae>
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104131:	81 c3 88 00 00 00    	add    $0x88,%ebx
      if(p->parent != curproc)
        continue;
      havekids = 1;
80104137:	b8 01 00 00 00       	mov    $0x1,%eax
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010413c:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80104142:	75 e2                	jne    80104126 <sys_waitx+0x66>
...
8010414a:	0f 84 ae 00 00 00    	je     801041fe <sys_waitx+0x13e>
80104150:	8b 46 24             	mov    0x24(%esi),%eax
80104153:	85 c0                	test   %eax,%eax
80104155:	0f 85 a3 00 00 00    	jne    801041fe <sys_waitx+0x13e>
      release(&ptable.lock);
      return -1;
    }
...
80104164:	e8 e7 fb ff ff       	call   80103d50 <sleep>
  }
80104169:	83 c4 10             	add    $0x10,%esp
8010416c:	eb 9b                	jmp    80104109 <sys_waitx+0x49>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
...
80104171:	ff 73 08             	pushl  0x8(%ebx)
      if(p->parent != curproc)
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
...
80104174:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80104177:	e8 54 e1 ff ff       	call   801022d0 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
8010417c:	5a                   	pop    %edx
8010417d:	ff 73 04             	pushl  0x4(%ebx)
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
        pid = p->pid;
...
80104180:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104187:	e8 f4 2b 00 00       	call   80106d80 <freevm>
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
        p->state = UNUSED;
...
8010418c:	8b 93 80 00 00 00    	mov    0x80(%ebx),%edx
80104192:	2b 53 7c             	sub    0x7c(%ebx),%edx
80104195:	2b 93 84 00 00 00    	sub    0x84(%ebx),%edx
...
801041b7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        ...
        *wtime = p->etime - p->ctime - p->rtime; // Waiting Time = End Time - Creation Time - Run Time
801041be:	89 10                	mov    %edx,(%eax)
        *rtime = p->rtime;                       // Run time
801041c0:	8b 93 84 00 00 00    	mov    0x84(%ebx),%edx
801041c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041c9:	89 10                	mov    %edx,(%eax)

        p->ctime = p->etime = p->rtime = 0; // Reinitialise
801041cb:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
801041d2:	00 00 00 
801041d5:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
801041dc:	00 00 00 
801041df:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)

        release(&ptable.lock);
801041e6:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801041ed:	e8 be 03 00 00       	call   801045b0 <release>
        return pid;
...
80104206:	e8 a5 03 00 00       	call   801045b0 <release>
      return -1;
...
80104240:	8b 48 10             	mov    0x10(%eax),%ecx
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104243:	05 88 00 00 00       	add    $0x88,%eax
80104248:	83 c2 24             	add    $0x24,%edx
    }
    else
    {
      // x->inuse[i] = 1;
    ...
    x[i].pid = p->pid;
8010424b:	89 4a dc             	mov    %ecx,-0x24(%edx)
    x[i].runtime = (float)p->rtime;
8010424e:	db 40 fc             	fildl  -0x4(%eax)
80104251:	d9 5a e0             	fstps  -0x20(%edx)
  struct proc *p;
  int i;
  i = 0;
  // lock the process table
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104254:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80104259:	75 e5                	jne    80104240 <getpinfo+0x20>
    x[i].runtime = (float)p->rtime;
...
80104263:	e8 48 03 00 00       	call   801045b0 <release>
  return 0;
...
8010427a:	68 38 77 10 80       	push   $0x80107738
...
801042d5:	e8 76 fa ff ff       	call   80103d50 <sleep>
...
80104334:	e8 d7 fb ff ff       	call   80103f10 <wakeup>
  release(&lk->lk);
...
801044b5:	68 5a 77 10 80       	push   $0x8010775a
...
801044c2:	68 43 77 10 80       	push   $0x80107743
...
801045a3:	68 61 77 10 80       	push   $0x80107761
...
801045ec:	68 69 77 10 80       	push   $0x80107769
...
80104a1a:	8b 14 85 a0 77 10 80 	mov    -0x7fef8860(,%eax,4),%edx
...
80104a40:	68 71 77 10 80       	push   $0x80107771
...
80104ba4:	68 18 78 10 80       	push   $0x80107818
...
80104bbc:	68 17 78 10 80       	push   $0x80107817
...
80104bd1:	68 0b 78 10 80       	push   $0x8010780b
...
80104bde:	68 1a 78 10 80       	push   $0x8010781a
...
80104beb:	68 fc 77 10 80       	push   $0x801077fc
...
8010516d:	68 3c 78 10 80       	push   $0x8010783c
...
8010517a:	68 4e 78 10 80       	push   $0x8010784e
...
80105187:	68 2a 78 10 80       	push   $0x8010782a
...
{
  return wait();
80105674:	e9 97 e7 ff ff       	jmp    80103e10 <wait>
...
8010569e:	e8 cd e8 ff ff       	call   80103f70 <kill>
...
8010574d:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
80105750:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  while(ticks - ticks0 < n){
...
8010576d:	e8 de e5 ff ff       	call   80103d50 <sleep>
...
80105834:	c6 04 c5 a4 4f 11 80 	movb   $0x0,-0x7feeb05c(,%eax,8)
8010583b:	00 
8010583c:	66 89 0c c5 a2 4f 11 	mov    %cx,-0x7feeb05e(,%eax,8)
80105843:	80 
80105844:	c6 04 c5 a5 4f 11 80 	movb   $0x8e,-0x7feeb05b(,%eax,8)
8010584b:	8e 
8010584c:	66 89 14 c5 a0 4f 11 	mov    %dx,-0x7feeb060(,%eax,8)
80105853:	80 
80105854:	c1 ea 10             	shr    $0x10,%edx
80105857:	66 89 14 c5 a6 4f 11 	mov    %dx,-0x7feeb05a(,%eax,8)
8010585e:	80 
void
tvinit(void)
{
...
80105879:	68 5d 78 10 80       	push   $0x8010785d
8010587e:	68 60 4f 11 80       	push   $0x80114f60
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105883:	66 89 15 a2 51 11 80 	mov    %dx,0x801151a2
8010588a:	c6 05 a4 51 11 80 00 	movb   $0x0,0x801151a4
80105891:	66 a3 a0 51 11 80    	mov    %ax,0x801151a0
80105897:	c1 e8 10             	shr    $0x10,%eax
8010589a:	c6 05 a5 51 11 80 ef 	movb   $0xef,0x801151a5
801058a1:	66 a3 a6 51 11 80    	mov    %ax,0x801151a6

  initlock(&tickslock, "time");
801058a7:	e8 f4 ea ff ff       	call   801043a0 <initlock>
}
...
801058cb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801058cf:	b8 a0 4f 11 80       	mov    $0x80114fa0,%eax
...
80105910:	ff 24 85 04 79 10 80 	jmp    *-0x7fef86fc(,%eax,4)
...
80105975:	68 c0 78 10 80       	push   $0x801078c0
...
801059fb:	75 a8                	jne    801059a5 <trap+0xb5>
    exit();
801059fd:	e8 be e1 ff ff       	call   80103bc0 <exit>
...
80105a0c:	75 ab                	jne    801059b9 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80105a0e:	e8 ed e2 ff ff       	call   80103d00 <yield>
...
80105a15:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105a18:	e8 53 dd ff ff       	call   80103770 <cpuid>
...
80105a1f:	0f 84 ab 00 00 00    	je     80105ad0 <trap+0x1e0>
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
80105a25:	e8 d6 cc ff ff       	call   80102700 <lapiceoi>
    break;
...
80105a2f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105a30:	e8 8b cb ff ff       	call   801025c0 <kbdintr>
    lapiceoi();
...
80105a57:	e8 14 dd ff ff       	call   80103770 <cpuid>
80105a5c:	56                   	push   %esi
80105a5d:	53                   	push   %ebx
80105a5e:	50                   	push   %eax
80105a5f:	68 68 78 10 80       	push   $0x80107868
80105a64:	e8 f7 ab ff ff       	call   80100660 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
80105a69:	e8 92 cc ff ff       	call   80102700 <lapiceoi>
    break;
...
80105a79:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105a80:	e8 bb c5 ff ff       	call   80102040 <ideintr>
...
80105a9a:	75 2c                	jne    80105ac8 <trap+0x1d8>
      exit();
    myproc()->tf = tf;
80105a9c:	e8 ef dc ff ff       	call   80103790 <myproc>
80105aa1:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105aa4:	e8 57 ef ff ff       	call   80104a00 <syscall>
    if(myproc()->killed)
...
80105abf:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80105ac0:	e9 fb e0 ff ff       	jmp    80103bc0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80105ac8:	e8 f3 e0 ff ff       	call   80103bc0 <exit>
...
80105ad3:	68 60 4f 11 80       	push   $0x80114f60
80105ad8:	e8 23 ea ff ff       	call   80104500 <acquire>
      ticks++;
      wakeup(&ticks);
80105add:	c7 04 24 a0 57 11 80 	movl   $0x801157a0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105ae4:	83 05 a0 57 11 80 01 	addl   $0x1,0x801157a0
      wakeup(&ticks);
80105aeb:	e8 20 e4 ff ff       	call   80103f10 <wakeup>
      release(&tickslock);
80105af0:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
...
80105b18:	68 8c 78 10 80       	push   $0x8010788c
80105b1d:	e8 3e ab ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105b22:	83 c4 14             	add    $0x14,%esp
80105b25:	68 62 78 10 80       	push   $0x80107862
...
80105b85:	e8 96 cb ff ff       	call   80102720 <microdelay>
{
  int i;
...
80105c1f:	bb 84 79 10 80       	mov    $0x80107984,%ebx
80105c24:	6a 00                	push   $0x0
80105c26:	6a 04                	push   $0x4
80105c28:	e8 63 c6 ff ff       	call   80102290 <ioapicenable>
...
80105cb7:	6a 00                	push   $0x0
  jmp alltraps
80105cb9:	e9 3c fb ff ff       	jmp    801057fa <alltraps>
...
80105cc0:	6a 01                	push   $0x1
  jmp alltraps
80105cc2:	e9 33 fb ff ff       	jmp    801057fa <alltraps>
...
80105cc9:	6a 02                	push   $0x2
  jmp alltraps
80105ccb:	e9 2a fb ff ff       	jmp    801057fa <alltraps>
...
80105cd2:	6a 03                	push   $0x3
  jmp alltraps
80105cd4:	e9 21 fb ff ff       	jmp    801057fa <alltraps>
...
80105cdb:	6a 04                	push   $0x4
  jmp alltraps
80105cdd:	e9 18 fb ff ff       	jmp    801057fa <alltraps>
...
80105ce4:	6a 05                	push   $0x5
  jmp alltraps
80105ce6:	e9 0f fb ff ff       	jmp    801057fa <alltraps>
...
80105ced:	6a 06                	push   $0x6
  jmp alltraps
80105cef:	e9 06 fb ff ff       	jmp    801057fa <alltraps>
...
80105cf6:	6a 07                	push   $0x7
  jmp alltraps
80105cf8:	e9 fd fa ff ff       	jmp    801057fa <alltraps>
...
80105cfd:	6a 08                	push   $0x8
  jmp alltraps
80105cff:	e9 f6 fa ff ff       	jmp    801057fa <alltraps>
...
80105d06:	6a 09                	push   $0x9
  jmp alltraps
80105d08:	e9 ed fa ff ff       	jmp    801057fa <alltraps>
...
80105d1b:	6a 0c                	push   $0xc
  jmp alltraps
80105d1d:	e9 d8 fa ff ff       	jmp    801057fa <alltraps>
...
80105d22:	6a 0d                	push   $0xd
  jmp alltraps
80105d24:	e9 d1 fa ff ff       	jmp    801057fa <alltraps>
...
80105d29:	6a 0e                	push   $0xe
  jmp alltraps
80105d2b:	e9 ca fa ff ff       	jmp    801057fa <alltraps>
...
80105d32:	6a 0f                	push   $0xf
  jmp alltraps
80105d34:	e9 c1 fa ff ff       	jmp    801057fa <alltraps>
...
80105d54:	6a 13                	push   $0x13
  jmp alltraps
80105d56:	e9 9f fa ff ff       	jmp    801057fa <alltraps>
...
80105d5d:	6a 14                	push   $0x14
  jmp alltraps
80105d5f:	e9 96 fa ff ff       	jmp    801057fa <alltraps>
...
80105d66:	6a 15                	push   $0x15
  jmp alltraps
80105d68:	e9 8d fa ff ff       	jmp    801057fa <alltraps>
...
80105d6f:	6a 16                	push   $0x16
  jmp alltraps
80105d71:	e9 84 fa ff ff       	jmp    801057fa <alltraps>
...
80105d78:	6a 17                	push   $0x17
  jmp alltraps
80105d7a:	e9 7b fa ff ff       	jmp    801057fa <alltraps>
...
80105d81:	6a 18                	push   $0x18
  jmp alltraps
80105d83:	e9 72 fa ff ff       	jmp    801057fa <alltraps>
...
80105d8a:	6a 19                	push   $0x19
  jmp alltraps
80105d8c:	e9 69 fa ff ff       	jmp    801057fa <alltraps>
...
80105d93:	6a 1a                	push   $0x1a
  jmp alltraps
80105d95:	e9 60 fa ff ff       	jmp    801057fa <alltraps>
...
80105d9c:	6a 1b                	push   $0x1b
  jmp alltraps
80105d9e:	e9 57 fa ff ff       	jmp    801057fa <alltraps>
...
80105da5:	6a 1c                	push   $0x1c
  jmp alltraps
80105da7:	e9 4e fa ff ff       	jmp    801057fa <alltraps>
...
80105dae:	6a 1d                	push   $0x1d
  jmp alltraps
80105db0:	e9 45 fa ff ff       	jmp    801057fa <alltraps>
...
80105db7:	6a 1e                	push   $0x1e
  jmp alltraps
80105db9:	e9 3c fa ff ff       	jmp    801057fa <alltraps>
...
80105dc0:	6a 1f                	push   $0x1f
  jmp alltraps
80105dc2:	e9 33 fa ff ff       	jmp    801057fa <alltraps>
...
80105dc9:	6a 20                	push   $0x20
  jmp alltraps
80105dcb:	e9 2a fa ff ff       	jmp    801057fa <alltraps>
...
80105dd2:	6a 21                	push   $0x21
  jmp alltraps
80105dd4:	e9 21 fa ff ff       	jmp    801057fa <alltraps>
...
80105ddb:	6a 22                	push   $0x22
  jmp alltraps
80105ddd:	e9 18 fa ff ff       	jmp    801057fa <alltraps>
...
80105de4:	6a 23                	push   $0x23
  jmp alltraps
80105de6:	e9 0f fa ff ff       	jmp    801057fa <alltraps>
...
80105ded:	6a 24                	push   $0x24
  jmp alltraps
80105def:	e9 06 fa ff ff       	jmp    801057fa <alltraps>
...
80105df6:	6a 25                	push   $0x25
  jmp alltraps
80105df8:	e9 fd f9 ff ff       	jmp    801057fa <alltraps>
...
80105dff:	6a 26                	push   $0x26
  jmp alltraps
80105e01:	e9 f4 f9 ff ff       	jmp    801057fa <alltraps>
...
80105e08:	6a 27                	push   $0x27
  jmp alltraps
80105e0a:	e9 eb f9 ff ff       	jmp    801057fa <alltraps>
...
80105e11:	6a 28                	push   $0x28
  jmp alltraps
80105e13:	e9 e2 f9 ff ff       	jmp    801057fa <alltraps>
...
80105e1a:	6a 29                	push   $0x29
  jmp alltraps
80105e1c:	e9 d9 f9 ff ff       	jmp    801057fa <alltraps>
...
80105e23:	6a 2a                	push   $0x2a
  jmp alltraps
80105e25:	e9 d0 f9 ff ff       	jmp    801057fa <alltraps>
...
80105e2c:	6a 2b                	push   $0x2b
  jmp alltraps
80105e2e:	e9 c7 f9 ff ff       	jmp    801057fa <alltraps>
...
80105e35:	6a 2c                	push   $0x2c
  jmp alltraps
80105e37:	e9 be f9 ff ff       	jmp    801057fa <alltraps>
...
80105e3e:	6a 2d                	push   $0x2d
  jmp alltraps
80105e40:	e9 b5 f9 ff ff       	jmp    801057fa <alltraps>
...
80105e47:	6a 2e                	push   $0x2e
  jmp alltraps
80105e49:	e9 ac f9 ff ff       	jmp    801057fa <alltraps>
...
80105e50:	6a 2f                	push   $0x2f
  jmp alltraps
80105e52:	e9 a3 f9 ff ff       	jmp    801057fa <alltraps>
...
80105e59:	6a 30                	push   $0x30
  jmp alltraps
80105e5b:	e9 9a f9 ff ff       	jmp    801057fa <alltraps>
...
80105e62:	6a 31                	push   $0x31
  jmp alltraps
80105e64:	e9 91 f9 ff ff       	jmp    801057fa <alltraps>
...
80105e6b:	6a 32                	push   $0x32
  jmp alltraps
80105e6d:	e9 88 f9 ff ff       	jmp    801057fa <alltraps>
...
80105e74:	6a 33                	push   $0x33
  jmp alltraps
80105e76:	e9 7f f9 ff ff       	jmp    801057fa <alltraps>
...
80105e7d:	6a 34                	push   $0x34
  jmp alltraps
80105e7f:	e9 76 f9 ff ff       	jmp    801057fa <alltraps>
...
80105e86:	6a 35                	push   $0x35
  jmp alltraps
80105e88:	e9 6d f9 ff ff       	jmp    801057fa <alltraps>
...
80105e8f:	6a 36                	push   $0x36
  jmp alltraps
80105e91:	e9 64 f9 ff ff       	jmp    801057fa <alltraps>
...
80105e98:	6a 37                	push   $0x37
  jmp alltraps
80105e9a:	e9 5b f9 ff ff       	jmp    801057fa <alltraps>
...
80105ea1:	6a 38                	push   $0x38
  jmp alltraps
80105ea3:	e9 52 f9 ff ff       	jmp    801057fa <alltraps>
...
80105eaa:	6a 39                	push   $0x39
  jmp alltraps
80105eac:	e9 49 f9 ff ff       	jmp    801057fa <alltraps>
...
80105eb3:	6a 3a                	push   $0x3a
  jmp alltraps
80105eb5:	e9 40 f9 ff ff       	jmp    801057fa <alltraps>
...
80105ebc:	6a 3b                	push   $0x3b
  jmp alltraps
80105ebe:	e9 37 f9 ff ff       	jmp    801057fa <alltraps>
...
80105ec5:	6a 3c                	push   $0x3c
  jmp alltraps
80105ec7:	e9 2e f9 ff ff       	jmp    801057fa <alltraps>
...
80105ece:	6a 3d                	push   $0x3d
  jmp alltraps
80105ed0:	e9 25 f9 ff ff       	jmp    801057fa <alltraps>
...
80105ed7:	6a 3e                	push   $0x3e
  jmp alltraps
80105ed9:	e9 1c f9 ff ff       	jmp    801057fa <alltraps>
...
80105ee0:	6a 3f                	push   $0x3f
  jmp alltraps
80105ee2:	e9 13 f9 ff ff       	jmp    801057fa <alltraps>
...
80105ee9:	6a 40                	push   $0x40
  jmp alltraps
80105eeb:	e9 0a f9 ff ff       	jmp    801057fa <alltraps>
...
80105ef2:	6a 41                	push   $0x41
  jmp alltraps
80105ef4:	e9 01 f9 ff ff       	jmp    801057fa <alltraps>
...
80105efb:	6a 42                	push   $0x42
  jmp alltraps
80105efd:	e9 f8 f8 ff ff       	jmp    801057fa <alltraps>
...
80105f04:	6a 43                	push   $0x43
  jmp alltraps
80105f06:	e9 ef f8 ff ff       	jmp    801057fa <alltraps>
...
80105f0d:	6a 44                	push   $0x44
  jmp alltraps
80105f0f:	e9 e6 f8 ff ff       	jmp    801057fa <alltraps>
...
80105f16:	6a 45                	push   $0x45
  jmp alltraps
80105f18:	e9 dd f8 ff ff       	jmp    801057fa <alltraps>
...
80105f1f:	6a 46                	push   $0x46
  jmp alltraps
80105f21:	e9 d4 f8 ff ff       	jmp    801057fa <alltraps>
...
80105f28:	6a 47                	push   $0x47
  jmp alltraps
80105f2a:	e9 cb f8 ff ff       	jmp    801057fa <alltraps>
...
80105f31:	6a 48                	push   $0x48
  jmp alltraps
80105f33:	e9 c2 f8 ff ff       	jmp    801057fa <alltraps>
...
80105f3a:	6a 49                	push   $0x49
  jmp alltraps
80105f3c:	e9 b9 f8 ff ff       	jmp    801057fa <alltraps>
...
80105f43:	6a 4a                	push   $0x4a
  jmp alltraps
80105f45:	e9 b0 f8 ff ff       	jmp    801057fa <alltraps>
...
80105f4c:	6a 4b                	push   $0x4b
  jmp alltraps
80105f4e:	e9 a7 f8 ff ff       	jmp    801057fa <alltraps>
...
80105f55:	6a 4c                	push   $0x4c
  jmp alltraps
80105f57:	e9 9e f8 ff ff       	jmp    801057fa <alltraps>
...
80105f5e:	6a 4d                	push   $0x4d
  jmp alltraps
80105f60:	e9 95 f8 ff ff       	jmp    801057fa <alltraps>
...
80105f67:	6a 4e                	push   $0x4e
  jmp alltraps
80105f69:	e9 8c f8 ff ff       	jmp    801057fa <alltraps>
...
80105f70:	6a 4f                	push   $0x4f
  jmp alltraps
80105f72:	e9 83 f8 ff ff       	jmp    801057fa <alltraps>
...
80105f79:	6a 50                	push   $0x50
  jmp alltraps
80105f7b:	e9 7a f8 ff ff       	jmp    801057fa <alltraps>
...
80105f82:	6a 51                	push   $0x51
  jmp alltraps
80105f84:	e9 71 f8 ff ff       	jmp    801057fa <alltraps>
...
80105f8b:	6a 52                	push   $0x52
  jmp alltraps
80105f8d:	e9 68 f8 ff ff       	jmp    801057fa <alltraps>
...
80105f94:	6a 53                	push   $0x53
  jmp alltraps
80105f96:	e9 5f f8 ff ff       	jmp    801057fa <alltraps>
...
80105f9d:	6a 54                	push   $0x54
  jmp alltraps
80105f9f:	e9 56 f8 ff ff       	jmp    801057fa <alltraps>
...
80105fa6:	6a 55                	push   $0x55
  jmp alltraps
80105fa8:	e9 4d f8 ff ff       	jmp    801057fa <alltraps>
...
80105faf:	6a 56                	push   $0x56
  jmp alltraps
80105fb1:	e9 44 f8 ff ff       	jmp    801057fa <alltraps>
...
80105fb8:	6a 57                	push   $0x57
  jmp alltraps
80105fba:	e9 3b f8 ff ff       	jmp    801057fa <alltraps>
...
80105fc1:	6a 58                	push   $0x58
  jmp alltraps
80105fc3:	e9 32 f8 ff ff       	jmp    801057fa <alltraps>
...
80105fca:	6a 59                	push   $0x59
  jmp alltraps
80105fcc:	e9 29 f8 ff ff       	jmp    801057fa <alltraps>
...
80105fd3:	6a 5a                	push   $0x5a
  jmp alltraps
80105fd5:	e9 20 f8 ff ff       	jmp    801057fa <alltraps>
...
80105fdc:	6a 5b                	push   $0x5b
  jmp alltraps
80105fde:	e9 17 f8 ff ff       	jmp    801057fa <alltraps>
...
80105fe5:	6a 5c                	push   $0x5c
  jmp alltraps
80105fe7:	e9 0e f8 ff ff       	jmp    801057fa <alltraps>
...
80105fee:	6a 5d                	push   $0x5d
  jmp alltraps
80105ff0:	e9 05 f8 ff ff       	jmp    801057fa <alltraps>
...
80105ff7:	6a 5e                	push   $0x5e
  jmp alltraps
80105ff9:	e9 fc f7 ff ff       	jmp    801057fa <alltraps>
...
80106000:	6a 5f                	push   $0x5f
  jmp alltraps
80106002:	e9 f3 f7 ff ff       	jmp    801057fa <alltraps>
...
80106009:	6a 60                	push   $0x60
  jmp alltraps
8010600b:	e9 ea f7 ff ff       	jmp    801057fa <alltraps>
...
80106012:	6a 61                	push   $0x61
  jmp alltraps
80106014:	e9 e1 f7 ff ff       	jmp    801057fa <alltraps>
...
8010601b:	6a 62                	push   $0x62
  jmp alltraps
8010601d:	e9 d8 f7 ff ff       	jmp    801057fa <alltraps>
...
80106024:	6a 63                	push   $0x63
  jmp alltraps
80106026:	e9 cf f7 ff ff       	jmp    801057fa <alltraps>
...
8010602d:	6a 64                	push   $0x64
  jmp alltraps
8010602f:	e9 c6 f7 ff ff       	jmp    801057fa <alltraps>
...
80106036:	6a 65                	push   $0x65
  jmp alltraps
80106038:	e9 bd f7 ff ff       	jmp    801057fa <alltraps>
...
8010603f:	6a 66                	push   $0x66
  jmp alltraps
80106041:	e9 b4 f7 ff ff       	jmp    801057fa <alltraps>
...
80106048:	6a 67                	push   $0x67
  jmp alltraps
8010604a:	e9 ab f7 ff ff       	jmp    801057fa <alltraps>
...
80106051:	6a 68                	push   $0x68
  jmp alltraps
80106053:	e9 a2 f7 ff ff       	jmp    801057fa <alltraps>
...
8010605a:	6a 69                	push   $0x69
  jmp alltraps
8010605c:	e9 99 f7 ff ff       	jmp    801057fa <alltraps>
...
80106063:	6a 6a                	push   $0x6a
  jmp alltraps
80106065:	e9 90 f7 ff ff       	jmp    801057fa <alltraps>
...
8010606c:	6a 6b                	push   $0x6b
  jmp alltraps
8010606e:	e9 87 f7 ff ff       	jmp    801057fa <alltraps>
...
80106075:	6a 6c                	push   $0x6c
  jmp alltraps
80106077:	e9 7e f7 ff ff       	jmp    801057fa <alltraps>
...
8010607e:	6a 6d                	push   $0x6d
  jmp alltraps
80106080:	e9 75 f7 ff ff       	jmp    801057fa <alltraps>
...
80106087:	6a 6e                	push   $0x6e
  jmp alltraps
80106089:	e9 6c f7 ff ff       	jmp    801057fa <alltraps>
...
80106090:	6a 6f                	push   $0x6f
  jmp alltraps
80106092:	e9 63 f7 ff ff       	jmp    801057fa <alltraps>
...
80106099:	6a 70                	push   $0x70
  jmp alltraps
8010609b:	e9 5a f7 ff ff       	jmp    801057fa <alltraps>
...
801060a2:	6a 71                	push   $0x71
  jmp alltraps
801060a4:	e9 51 f7 ff ff       	jmp    801057fa <alltraps>
...
801060ab:	6a 72                	push   $0x72
  jmp alltraps
801060ad:	e9 48 f7 ff ff       	jmp    801057fa <alltraps>
...
801060b4:	6a 73                	push   $0x73
  jmp alltraps
801060b6:	e9 3f f7 ff ff       	jmp    801057fa <alltraps>
...
801060bd:	6a 74                	push   $0x74
  jmp alltraps
801060bf:	e9 36 f7 ff ff       	jmp    801057fa <alltraps>
...
801060c6:	6a 75                	push   $0x75
  jmp alltraps
801060c8:	e9 2d f7 ff ff       	jmp    801057fa <alltraps>
...
801060cf:	6a 76                	push   $0x76
  jmp alltraps
801060d1:	e9 24 f7 ff ff       	jmp    801057fa <alltraps>
...
801060d8:	6a 77                	push   $0x77
  jmp alltraps
801060da:	e9 1b f7 ff ff       	jmp    801057fa <alltraps>
...
801060e1:	6a 78                	push   $0x78
  jmp alltraps
801060e3:	e9 12 f7 ff ff       	jmp    801057fa <alltraps>
...
801060ea:	6a 79                	push   $0x79
  jmp alltraps
801060ec:	e9 09 f7 ff ff       	jmp    801057fa <alltraps>
...
801060f3:	6a 7a                	push   $0x7a
  jmp alltraps
801060f5:	e9 00 f7 ff ff       	jmp    801057fa <alltraps>
...
801060fc:	6a 7b                	push   $0x7b
  jmp alltraps
801060fe:	e9 f7 f6 ff ff       	jmp    801057fa <alltraps>
...
80106105:	6a 7c                	push   $0x7c
  jmp alltraps
80106107:	e9 ee f6 ff ff       	jmp    801057fa <alltraps>
...
8010610e:	6a 7d                	push   $0x7d
  jmp alltraps
80106110:	e9 e5 f6 ff ff       	jmp    801057fa <alltraps>
...
80106117:	6a 7e                	push   $0x7e
  jmp alltraps
80106119:	e9 dc f6 ff ff       	jmp    801057fa <alltraps>
...
80106120:	6a 7f                	push   $0x7f
  jmp alltraps
80106122:	e9 d3 f6 ff ff       	jmp    801057fa <alltraps>
...
80106135:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010613a:	e9 bb f6 ff ff       	jmp    801057fa <alltraps>
...
80106141:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106146:	e9 af f6 ff ff       	jmp    801057fa <alltraps>
...
80106774:	e8 07 bd ff ff       	call   80102480 <kalloc>
...
8010682d:	68 8c 79 10 80       	push   $0x8010798c
...
80106884:	e8 47 ba ff ff       	call   801022d0 <kfree>
      *pte = 0;
...
801068d2:	68 26 73 10 80       	push   $0x80107326
...
801069e0:	a1 a4 57 11 80       	mov    0x801157a4,%eax
...
80106a24:	0f 84 c4 00 00 00    	je     80106aee <switchuvm+0xee>
  ...
  pushcli();
80106a2a:	e8 f1 d9 ff ff       	call   80104420 <pushcli>
...
80106adb:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106adc:	e9 7f d9 ff ff       	jmp    80104460 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106ae4:	68 92 79 10 80       	push   $0x80107992
...
80106af1:	68 bd 79 10 80       	push   $0x801079bd
...
80106afe:	68 a8 79 10 80       	push   $0x801079a8
...
80106b2b:	77 49                	ja     80106b76 <inituvm+0x66>
  ...
  mem = kalloc();
80106b2d:	e8 4e b9 ff ff       	call   80102480 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106b3f:	e8 bc da ff ff       	call   80104600 <memset>
...
80106b70:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106b71:	e9 3a db ff ff       	jmp    801046b0 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106b79:	68 d1 79 10 80       	push   $0x801079d1
...
80106c01:	e8 3a ad ff ff       	call   80101940 <readi>
...
80106c2d:	68 eb 79 10 80       	push   $0x801079eb
...
80106c3a:	68 8c 7a 10 80       	push   $0x80107a8c
...
80106c93:	e8 68 d9 ff ff       	call   80104600 <memset>
...
80106cc1:	76 7d                	jbe    80106d40 <allocuvm+0xf0>
    mem = kalloc();
80106cc3:	e8 b8 b7 ff ff       	call   80102480 <kalloc>
    if(mem == 0){
...
80106cd1:	68 09 7a 10 80       	push   $0x80107a09
...
80106d03:	68 21 7a 10 80       	push   $0x80107a21
...
80106d26:	e8 a5 b5 ff ff       	call   801022d0 <kfree>
      return 0;
...
80106dce:	e8 fd b4 ff ff       	call   801022d0 <kfree>
...
80106de3:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106de4:	e9 e7 b4 ff ff       	jmp    801022d0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
...
80106dec:	68 3d 7a 10 80       	push   $0x80107a3d
...
80106e05:	e8 76 b6 ff ff       	call   80102480 <kalloc>
...
80106ebf:	68 4e 7a 10 80       	push   $0x80107a4e
...
80106f65:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106f68:	e8 13 b5 ff ff       	call   80102480 <kalloc>
...
80106fa4:	e8 27 b3 ff ff       	call   801022d0 <kfree>
      goto bad;
...
80106fb5:	68 72 7a 10 80       	push   $0x80107a72
...
80106fc2:	68 58 7a 10 80       	push   $0x80107a58
