...
int main(int argc, char *argv[])
{
  ...
  10:	83 ec 24             	sub    $0x24,%esp
	for(int i=0;i<1e4;i++)
  13:	d9 05 2c 07 00 00    	flds   0x72c
  19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  20:	83 c2 01             	add    $0x1,%edx
	{
		volatile int x = 1;
  23:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
		x++;
...
int main(int argc, char *argv[])
{
  ...
  4d:	e8 ae 03 00 00       	call   400 <printf>
	exit();
  52:	e8 4b 02 00 00       	call   2a2 <exit>
  57:	66 90                	xchg   %ax,%ax
  59:	66 90                	xchg   %ax,%ax
  5b:	66 90                	xchg   %ax,%ax
  5d:	66 90                	xchg   %ax,%ax
...
putc(int fd, char c)
{
 ...
 518:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 51b:	b8 30 07 00 00       	mov    $0x730,%eax
