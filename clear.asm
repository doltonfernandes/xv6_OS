...
clear()
{
  ...
  43:	53                   	push   %ebx
  44:	bb 3d 00 00 00       	mov    $0x3d,%ebx
...
clear()
{
  ...
  62:	83 eb 01             	sub    $0x1,%ebx
  65:	75 e9                	jne    50 <clear+0x10>
	{
		printf(1,"\xa");
	}
}
  67:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  6a:	c9                   	leave  
  6b:	c3                   	ret    
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
...
putc(int fd, char c)
{
 ...
 518:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 51b:	b8 22 07 00 00       	mov    $0x722,%eax
